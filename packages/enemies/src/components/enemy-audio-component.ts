 ...
 */
export function createAudioComponent(enemyType: EnemyType, _scene: Scene): EnemyAudioComponent {
  const component: EnemyAudioComponent = {
    ...
    audioConfig: createDefaultAudioConfig(enemyType),
    isEnabled: true,
    masterVolume: 1.0,
    lastTriggerTime: initializeLastTriggerTime(),
...
export function updateAudioComponent(
  ...
  updateDistanceLOD(component);

  // Clean up finished sounds
  cleanupFinishedSounds(component);
}

/**
 * Check if audio can be triggered for given state
 */
export function canTriggerAudio(
  component: EnemyAudioComponent,
  state: EnemyState,
  currentTime: number
): boolean {
 ...
 */
export function markAudioTriggered(
  component: EnemyAudioComponent,
  state: EnemyState,
  currentTime: number
): void {
 ...
 */
export function addActiveSound(
  component: EnemyAudioComponent,
  soundId: string,
  sound: Sound
): void {
 ...
 */
export function removeActiveSound(component: EnemyAudioComponent, soundId: string): void {
 ...
 */
export function stopAllSounds(component: EnemyAudioComponent): void {
 ...
 */
export function getComponentStats(component: EnemyAudioComponent): Partial<EnemyAudioStats> {
  return {
 ...
 */
function createDefaultAudioConfig(enemyType: EnemyType): Record<EnemyState, AudioStateConfig> {
  // Base configuration
 ...
 */
function initializeLastTriggerTime(): Record<EnemyState, number> {
  return {
    [EnemyState.IDLE]: 0,
 ...
 */
function updateDistanceLOD(component: EnemyAudioComponent): void {
 ...
 */
function cleanupFinishedSounds(component: EnemyAudioComponent): void {
  ...
  for (const soundId of soundsToRemove) {
    removeActiveSound(component, soundId);
  }
}
